...
def send_register_randomness_tx(chain, contract, keypair):
...
def send_attempt_xor_3_tx(chain, contract, keypair):
...
def just_give_me_a_badge(chain, contract, keypair):
...
def example_interaction_hardxore():
    ...
    just_give_me_a_badge(aleph_testnet, contract, keypair)
    send_register_randomness_tx(aleph_testnet, contract, keypair)
    send_attempt_xor_3_tx(aleph_testnet, contract, keypair)
